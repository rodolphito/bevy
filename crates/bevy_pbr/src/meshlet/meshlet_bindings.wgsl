...
@group(0) @binding(8) var meshlet_visibility_buffer: texture_storage_2d<r64uint, atomic>; // Per pixel
#else
@group(0) @binding(8) var meshlet_visibility_buffer: texture_storage_2d<r32uint, atomic>; // Per pixel
#endif
...
@group(1) @binding(0) var meshlet_visibility_buffer: texture_storage_2d<r64uint, read>; // Per pixel
